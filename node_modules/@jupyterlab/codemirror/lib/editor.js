...
require("codemirror/addon/display/rulers.js");
...
class CodeMirrorEditor {
    ...
    constructor(options) {
        ...
        this._uuid = options.uuid || coreutils_3.UUID.uuid4();
        ...
        this._poll = new coreutils_2.Poll({
            factory: () => __awaiter(this, void 0, void 0, function* () {
                this._checkSync();
            }),
    ...
    _onMimeTypeChanged() {
        ...
        void mode_1.Mode.ensure(mime).then(spec => {
