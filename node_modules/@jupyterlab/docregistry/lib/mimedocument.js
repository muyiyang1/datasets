...
class MimeContent extends widgets_1.Widget {
    ...
    constructor(options) {
        ...
        this._changeCallback = (options) => {
            ...
            if (typeof data === 'string') {
                ...
                if (!coreutils_2.JSONExt.deepEqual(data, this._context.model.toJSON())) {
        ...
        this._context.ready
            ...
            void apputils_1.showErrorMessage(`Renderer Failure: ${this._context.path}`, reason);
        });
    }
    /**
    ...
    _render() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let mimeModel = new rendermime_1.MimeModel({
                data,
            ...
            try {
                ...
                void apputils_1.showErrorMessage(`Renderer Failure: ${context.path}`, reason);
            }
        });
    }
}
