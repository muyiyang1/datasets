 ...
 */
exports.ILabShell = new coreutils_1.Token('@jupyterlab/application:ILabShell');
/**
 * The application shell for JupyterLab.
 */
class LabShell extends widgets_1.Widget {
    /**
    ...
    constructor() {
        ...
        let headerPanel = (this._headerPanel = new widgets_1.Panel());
