...
function _templateObject2() {
  var data = _taggedTemplateLiteral(["\n  stroke-dasharray: 100;\n  animation: ", " 5s ", "s cubic-bezier(0.455, 0.03, 0.515, 0.955)\n    infinite;\n"]);
...
var spinnerClass = function spinnerClass() {
  var delay = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
  return css(_templateObject2(), dash, delay);
};

var Lines = styled.path.withConfig({
  displayName: "Loading__Lines"
})(["stroke:", ";stroke-width:3px;"], get('colors.primary'));
var Path = styled.path.withConfig({
...
var Spinner = function Spinner(_ref) {
  ...
  return React.createElement("svg", {
    ...
    id: "Combined-Shape",
    fill: "#1F2D3D"
  }), React.createElement(_StyledLines, {
    d: "M31.5,18.5 L38.5,18.5",
    id: "Line",
    strokeWidth: "5",
    strokeLinecap: "round",
    strokeLinejoin: "round",
    _css: spinnerClass(1.5)
  }), React.createElement(_StyledLines2, {
    d: "M47.75,18.5 L86.25,18.5",
    id: "Line",
    strokeWidth: "5",
    "stroke-linecap": "round",
    strokeLinejoin: "round",
    _css2: spinnerClass(0.2)
  }), React.createElement(_StyledLines3, {
    d: "M30.9375,38.5 L72.0625,38.5",
    id: "Line",
    strokeWidth: "5",
    "stroke-linecap": "round",
    strokeLinejoin: "round",
    _css3: spinnerClass(1)
  }), React.createElement(_StyledLines4, {
    d: "M31,56.5 L59,56.5",
    id: "Line",
    strokeWidth: "5",
    "stroke-linecap": "round",
    strokeLinejoin: "round",
    _css4: spinnerClass(3)
  }), React.createElement(_StyledLines5, {
    d: "M31.375,72.5 L50.625,72.5",
    id: "Line",
    strokeWidth: "5",
    "stroke-linecap": "round",
    strokeLinejoin: "round",
    _css5: spinnerClass(2)
  })));
};

export var Loading = function Loading() {
  return React.createElement(Wrapper, null, React.createElement(Spinner, null));
};

var _StyledLines = _styled(Lines)(_templateObject3(), function (p) {
  return p._css;
});

var _StyledLines2 = _styled2(Lines)(_templateObject4(), function (p) {
  return p._css2;
});

var _StyledLines3 = _styled3(Lines)(_templateObject5(), function (p) {
  return p._css3;
});

var _StyledLines4 = _styled4(Lines)(_templateObject6(), function (p) {
  return p._css4;
});

var _StyledLines5 = _styled5(Lines)(_templateObject7(), function (p) {
  return p._css5;
});